...
import { ExamDocumentSection } from './features/exam-document-section';
import { ExamStatusActions } from './features/exam-status-actions';
...
const ExamDetailPage = async ({ params }: { params: Promise<{ exam_id: string }> }) => {
                    ...
                    <div className="space-y-6">
                        <article className="rounded-2xl border border-border bg-surface p-5 shadow-card">
                            ...
                            <p className="mt-1 text-xs text-ink-soft">
                                Altere a visibilidade deste exame.
                            </p>
                            <div className="mt-4">
